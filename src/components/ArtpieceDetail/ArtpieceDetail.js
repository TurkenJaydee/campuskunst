            ...
            <Fragment>
                ...
                <Container className={classes.attributesWrapper} maxWidth="md">
                    <div className={classes.attributeHeader}>
                        <Typography variant="h3" className={classes.title}>{artpiece.name}</Typography>
                        <Typography variant="subtitle1" align='center' className={classes.subtitle}>{artpiece.subtitle}</Typography>
                        <Typography variant="subtitle2" className={classes.tags}>
                            {artpiece.tags.split(',').map((tag, id) => {
                                return (
                                    <div className={classes.tag} key={id}><LocalOfferOutlinedIcon className={classes.tagIcon} />{tag}</div>
                                );
                            })}
                        </Typography>
                    </div>
                    <div className={classes.attributes}>
                        <div className={classes.attribute}>
                            <Typography variant="h5" className={classes.artistHeading}>KünstlerIn</Typography>
                            {artpiece.artist}
                        </div>

                        <div className={classes.attribute}>
                            <Typography variant="h5" className={classes.artistHeading}>Datum</Typography>
                            {artpiece.date}
                        </div>
                        <div className={classes.attribute}>
                            <Typography variant="h5" className={classes.artistHeading}>Größe</Typography>
                            12x36cm
                        </div>
                    </div>
                    <FormControlLabel
                    ...
                    <div className={classes.descriptionSection}>
                        <Typography className={classes.description} dangerouslySetInnerHTML={{ __html: getTextStyle() }} variant="body2" color="textSecondary" component="p"></Typography>
                    </div>
