                    ...
                    <Typography role="main" component={'span'}>
                        <div className={`${classes.section} ${classes.art}`}>
                            <Container maxWidth="md">
                                ...
                                />
                                <Typography className={classes.firstChapter} variant="h4"><Typography variant="h2" display="inline" className={classes.keyword}>KUNST</Typography> <span className={classes.sectionHeading}>AN DER UNIVERSITÄT BREMEN </span></Typography>
                        ...
                        <div className={`${classes.section} ${classes.program}`}>
                            <Container maxWidth="md">
                                <Grid container spacing={3} alignItems="center">
                                    ...
                                    <Grid item sm={12} md={6}>
                                    <Typography variant="h4"><Typography variant="h2" display="inline" className={classes.keyword}>PROGRAMM</Typography> <br />"KUNST IM UNIVERSITÄTSBEREICH"</Typography>
                        ...
                        <div className={`${classes.section} ${classes.goals}`}>
                            <Container maxWidth="md">
                                <Grid container spacing={3} alignItems="center">
                                    <Grid item sm={12} md={6}>
                                    <Typography variant="h4"><Typography variant="h2" display="inline" className={classes.keyword}>ZIELE </Typography> DES BREMER HOCHSCHULMODELLS</Typography>
                            ...
                            <Container maxWidth="md">
                                <Grid container spacing={3} alignItems="center">
                                    ...
                                    <Grid className={classes.premiseList} item sm={12} md={6}>
                                        <div>
                                        <Typography variant="h4">ES GALTEN ZWEI <Typography variant="h2" display="inline" className={classes.keyword}>PRÄMISSEN</Typography></Typography>
